# Selection Standards pattern — light refresh (2026-08-11)

**Pattern updated:** `2847` — Truth Collective Trusted Selection Standards Governance  
**Scaffold:** `diagnostics/scaffolds/pattern-2847-selection-standards-light.html`  
**Backup:** `diagnostics/backups/pattern-2847-before-light-2026-08-11.html`  
**Reference PDF (image-based):** `docs/brand-references/selection-standards/multistage-engineering-overview-II.pdf`

## Locked meaning (Daniel)
| Track | Applies to | Role |
|-------|------------|------|
| **Quantitative** | Any **product** | Weighted engineering / category metrics; independent of Amazon-style popularity |
| **Qualitative** | **Books, podcasts, editorial scripts** | Literature and editorial evaluation under TC governance |
